...
public class EditOwner extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        String sql_call = "select id AS ID, callsign AS CALLSIGN, name AS NAME, surname AS SURNAME, country AS COUNTRY, licence_class AS 'LICENCE CLASS', notes as NOTES from log_owner";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditOwner.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
