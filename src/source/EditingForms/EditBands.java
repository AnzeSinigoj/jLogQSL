 ...
 * @author anze
 */
public class EditBands extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditBands.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
