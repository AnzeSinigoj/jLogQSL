 ...
 * @author anze
 */
public class EditQTH extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (selected < 1) {
            ...
            String sql = "DELETE FROM custom_qths WHERE id = ?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditQTH.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
