 ...
 * @author anze
 */
public class ViewQTH extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        String sql_call = "select id AS ID, name AS NAME, qra_locator AS 'QRA LOCATOR', latitude as LATITUDE, longitude as LONGITUDE from custom_qths";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewQTH.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
