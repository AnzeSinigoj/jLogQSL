 ...
 * @author anze
 */
public class SearchCallsignResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Callsign search result:");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        String sql_call = "SELECT L.ID AS ID, L.callsign AS CALLSIGN, L.date AS 'DATE & TIME', L.sent_report AS 'SENT REPORT', L.received_report AS 'RECEIVED REPORT', "
                + "B.name AS BAND, M.name AS MODE, L.power AS POWER, L.qth AS QTH, Q.name AS 'MY QTH', L.note AS NOTE "
                + "FROM log_entries L "
                + "INNER JOIN modes M ON M.id = L.modes_id "
                + "INNER JOIN BANDS B ON B.id = L.bands_id "
                + "INNER JOIN custom_qths Q ON Q.id = L.custom_qths_id "
                + "where callsign = '" + SearchCallsign.searchCall.toUpperCase() + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchCallsignResult.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
